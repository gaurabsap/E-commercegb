...
const Home = () => {
  ...
  useEffect(() => {
    const GetCategories = async () => {
      const resq = await axios.get("http://127.0.0.1:5000/api/v1/get/category");
      // console.log(resq)
  ...
  useEffect(() => {
    const GetProducts = async () => {
      const resq = await axios.get(
        "http://127.0.0.1:5000/api/v1/get-products?limit=4"
      );
                  ...
                  <div className="header">
                    <div className="titles">
                      ...
                      <h3>
                        ...
                        adipisicing elit. Voluptas vero enim saepe voluptate,
                        earum ab provident. Dolor alias ea vel!
                      </h3>
